  ...
  return (
    <div className='flex flex-col md:flex-row items-center justify-between gap-8 p-4 sm:p-4 md:px-8 md:py-14 max-w-7xl mx-auto'>
        ...
        <div className='flex-1 flex flex-col text-center md:text-left md:space-y-3'>
            ...
            <p className='md:max-w-3xl text-xl text-gray-600 my-4'>Explore frontend, backend, database and tooling options,<br/>compare them side by side, and put together the stack that fits your next project</p>
